	...
	constructor(locale) {
		...
		;(this.sentencePausePunctuation = '\\,\\:\\;'),
			(this.sentencePunctuation =
				this.sentencePausePunctuation + this.terminalPunctuation) // there is no ellipsis in the set as it is being used throughout a sentence in the middle. Rethink this group to split it into end-sentence punctuation and middle sentence punctuation
		...
		*/
		...
		this.romanOrdinalIndicator =
			typopoLocale[locale].numbers.romanOrdinalIndicator
